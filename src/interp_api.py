...
def get_time_value(pos_file_path:str, qua_lines_info:list, timestamp):
    """读取wgs84位置信息,四元数信息
    ...
    pos_y_list = []
    pos_z_list = []
    # lines_info = pos_file_path.read().decode().splitlines()
    for line_info in pos_file_path:
    ...
    # qua_lines_info = qua_list_path.read().decode().splitlines()
